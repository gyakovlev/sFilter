...
--    frame.icon.backround:
--    frame.icon:SetVertexColor(.6, .6, .6);
...
--Fit tukui border color
    frame.overlay:SetVertexColor(.6, .6, .6)
    frame.overlay:SetTexCoord(0.04, 0.96, 0.04, 0.96)
--
